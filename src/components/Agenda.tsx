...
const AGENDA_PERIODS = [
  {
    ...
    items: [
      ...
      { time: "9:32 AM", end: "10:00 AM", title: "Opening Keynote", type: "keynote" as const },
      { time: "10:00 AM", end: "10:28 AM", title: "Technical Session 1", type: "session" as const },
      { time: "10:30 AM", end: "11:00 AM", title: "Technical Session 2", type: "session" as const },
      { time: "11:00 AM", end: "11:13 AM", title: "Diamond Sponsor Session", type: "sponsor" as const },
      { time: "11:15 AM", end: "11:45 AM", title: "Technical Session 3", type: "session" as const },
  ...
  },
  {
    ...
    label: "Afternoon",
    items: [
      { time: "1:45 PM", end: "2:15 PM", title: "Technical Session 4", type: "session" as const },
      { time: "2:15 PM", end: "2:30 PM", title: "Diamond Sponsor Session", type: "sponsor" as const },
      { time: "2:30 PM", end: "2:58 PM", title: "Technical Session 5", type: "session" as const },
