...
export default function About() {
  ...
  // Calculate position for the centered custom sliding pill
  // The progress bar track is 80px wide. The sliding pill is 30px wide.
  // Maximum travel is 50px (from 0px to 50px).
  ...
  return (
    <section id="about" className={`section ${styles.about}`}>
      <div className="container">
        ...
        {/* Custom Centered Sliding Pill Scroll Indicator (matches screenshot) */}
